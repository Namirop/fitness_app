...
class _FoodSearchScreenState extends State<FoodSearchScreen> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        final validation = await _showCacheDialog(food);
                        if (validation == true) {
                          print("COUCOU COSSI");
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  SizedBox(height: 5),
                                  Text(
                                    "G: ${food.carbs.toStringAsFixed(1)} P: ${food.proteins.toStringAsFixed(1)} L: ${food.fats.toStringAsFixed(1)}",
                                  ),
                                ],
                              ),
                            ],
  ...
  Future<bool?> _showCacheDialog(FoodEntity food) async {
    ...
    return await showDialog<bool>(
      ...
      // StatefulBuilder car le context de la dialogBox est différent, sinon ne rebuild pas après le setState
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: Column(
                children: [
                  Text(
                    "G: ${totalCarbs.toStringAsFixed(1)} P: ${totalProteins.toStringAsFixed(1)} L: ${totalFats.toStringAsFixed(1)} - ${totalCalories.toStringAsFixed(1)}kcal",
                    maxLines: 1,
                              ...
                              child: TextField(
                                ...
                                onChanged: (value) {
                                  ...
                                  setDialogState(() {
                                    ...
                                    totalProteins =
                                        food.proteins * quantity / 100;
                                    totalFats = food.carbs * quantity / 100;
                                  });
                                },
                              ),
                            ),
