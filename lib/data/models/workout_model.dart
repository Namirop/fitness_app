...
import 'package:workout_app/data/models/workout_exercice_model.dart';
...
class WorkoutModel extends WorkoutEntity {
  ...
  factory WorkoutModel.fromJson(Map<String, dynamic> json) {
    return WorkoutModel(
      ...
      exercices: (json['exercices'] as List)
        .map((ex) => WorkoutExerciceModel.fromJson(ex))
        .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'exercices': exercices.map((ex) => WorkoutExerciceModel.fromEntity(ex).toJson()).toList(),
    };
  }
}
