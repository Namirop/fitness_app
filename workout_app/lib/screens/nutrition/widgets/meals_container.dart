...
class MealsContainer extends StatelessWidget {
  ...
  final int selectedMealTypeIndex = 0;
          ...
          child: isLoading
              ...
              : PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _mealContainer(meals[index], context);
                  },
                ),
        ),
  ...
  Widget _mealContainer(MealEntity meal, BuildContext context) {
    return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (meal.foodPortions.isNotEmpty) ...[
                SizedBox(height: 10),
                _buildAddButton(context, meal.type),
              ],
            ],
          ),
        ),
            ...
            Dismissible(
              ...
              onDismissed: (direction) {
                context.read<NutritionBloc>().add(
                  DeleteFoodPortionFromMeal(foodPortion, meal.type),
                );
              },
  ...
  Widget _buildAddButton(BuildContext context, MealType mealType) {
